...
3. In the Jupyter home page, in the **DP-100** folder, open the **09B - Interpreting Models.ipynb** notebook. Then read the notes in the notebook, running each code cell in turn.
